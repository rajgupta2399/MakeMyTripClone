...
import sliderImg2 from "../../../../public/Assets/ud.png";
      ...
      >
          ...
          <Carousel.Caption className={styles.carouselCaption}>
            <div className={styles.slider_des}>
              <AnimatedText
                ...
                className="!text-6xl xl:!text-6xl lg:!text-7xl md:!text-6xl !text-[20px] !text-center leading-[120%]"
              />
        ...
        <Carousel.Item className={styles.carousel}>
          ...
          <Carousel.Caption className={styles.carouselCaption}>
            <div className={styles.slider_des}>
              <AnimatedText
                text="Book Your Favourite Hotels On MakeMyTrip"
                className="!text-6xl xl:!text-6xl lg:!text-8xl md:!text-6xl !text-[20px] !text-center leading-[120%]"
              />
              <p className={styles.sub_text}>
                Book your favorite hotel rooms effortlessly with MakeMyTrip,
                where comfort meets convenience. Whether you're traveling for
          ...
          <Carousel.Caption className={styles.carouselCaption}>
            <div className={styles.slider_des}>
              <AnimatedText
                ...
                className="!text-6xl xl:!text-6xl lg:!text-8xl md:!text-6xl !text-[20px] !text-center"
              />
              <p className={styles.sub_text}>
                Book your favorite hotel rooms effortlessly with MakeMyTrip,
                where comfort meets convenience. Whether you're traveling for
        ...
        <Carousel.Item className={styles.carousel}>
          ...
          <Carousel.Caption className={styles.carouselCaption}>
            <div className={styles.slider_des}>
              <AnimatedText
                text="Book Your Desination On MakeMyTrip"
                className="!text-6xl xl:!text-6xl lg:!text-8xl md:!text-6xl !text-[20px] !text-center"
              />
              <p className={styles.sub_text}>
