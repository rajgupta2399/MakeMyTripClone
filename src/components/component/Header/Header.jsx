...
export default function Header() {
    ...
    return (
        <header
            className={`${theme === "light" ? "bg-white text-[#1D232A]" : "bg-[#1D232A] text-white"
                }  shadow-lg`}
        >
            <nav
                aria-label="Global"
            ...
            >
                ...
                <div className="flex lg:hidden">
                    <button
                        ...
                        className={`-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 ${theme === "light" ? "text-gray-700" : "text-white"
                            }`}
                    >
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                    <Popover className="relative">
                        <PopoverButton
                            className={`flex items-center gap-x-1 text-sm font-semibold leading-6 ${theme === "light" ? "#1D232A" : "text-white"
                                }`}
                        >
                            <Link
                                href={"/Flights/"}
                  ...
                  */}
                        ...
                        <PopoverPanel
                            className={`absolute -left-8 top-full z-10 mt-3 w-screen max-w-md overflow-hidden rounded-3xl shadow-lg ring-1 ring-gray-900/5 ${theme === "light" ? "bg-white" : "bg-gray-800"
                                }`}
                        >
                            {/* Product panel */}
                        </PopoverPanel>
                    ...
                    <Link
                        href={"/Hotels/"}
                        className={`${theme === "light" ? "#1D232A" : "text-white"
                 ...
                 */}
                    ...
                    <a
                        href="#"
                        className={`text-sm font-semibold leading-6 ${theme === "light" ? "#1D232A" : "text-white"
                            }`}
                    >
                        <Link
                            href={"/Trains/"}
