...
const AdvanceSearchHome = () => {
  const { theme } = useTheme();

  return (
    <>
      <div
        className={`rounded-lg sm:relative w-[calc(100% - 40px)] ml-0 sm:h-[235px] h-[360px] mb-0 p-4 flex sm:flex-row sm:gap-4 items-center justify-center ${
          theme === "light"
...
export default AdvanceSearchHome;
