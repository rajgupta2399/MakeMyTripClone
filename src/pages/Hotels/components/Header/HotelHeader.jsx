...
export default function HotelHeader() {
    ...
    return (
        <header
            className={`${headerVisible ? "translate-y-0" : "-translate-y-full"
                } transition-transform duration-300 ${theme === "light"
        ...
        >
            ...
            >
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12 ml-20 text-white">
